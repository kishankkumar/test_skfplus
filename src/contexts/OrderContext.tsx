  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      ...
      items: {
        selectedSabjis: [
          { id: '1', name: 'Dal Tadka', image: '/api/placeholder/80/80', type: 'veg', taste: 'mild' },
          { id: '2', name: 'Paneer Butter Masala', image: '/api/placeholder/80/80', type: 'veg', taste: 'mild' },
        ],
        baseOption: 'both',
        extraRoti: 1,
    ...
    },
    {
      ...
      items: {
        selectedSabjis: [
          { id: '3', name: 'Rajma', image: '/api/placeholder/80/80', type: 'veg', taste: 'mild' },
        ],
        baseOption: 'roti-only',
        extraRoti: 0,
